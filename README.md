...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-21--21%3A17%3A31-green.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-09-21 21:17:31`
> 运行分析：从 `9` 个活跃源中抓取 `1046` 个节点，耗时 `0.30s`。去重后保留 `900` 个有效节点。

<div style="overflow-x: auto;">

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇨🇭瑞士 | 🇮🇳印度 | 🇹🇷土耳其 | 🇦🇺澳大利亚 | 🇲🇾马来西亚 | 🇧🇷巴西 | 🇦🇷阿根廷 | 🇲🇽墨西哥 | 🇮🇹意大利 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇮🇪爱尔兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇨🇿捷克 | 🇦🇹奥地利 | 🇦🇪阿联酋 | 🇨🇾塞浦路斯 | 🇺🇦乌克兰 | 🇳🇴挪威 | 🇩🇰丹麦 | 🇭🇺匈牙利 | 🇧🇬保加利亚 | 🇿🇦南非 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 40 | 12 | 38 | 262 | 34 | 25 | 23 | 17 | 12 | 5 | 3 | 16 | 5 | 4 | 7 | 3 | 1 | 2 | 1 | 1 | 2 | 12 | 13 | 119 | 4 | 2 | 6 | 4 | 2 | 4 | 3 | 2 | 2 | 1 | 2 | 1 | 1 | 1 | 208 | **900** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `53.24%` |
| 2 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `13.94%` |
| 3 | `📡 shaoyouvip 每日更新` | **94** 个 | `9.10%` |
| 4 | `[长效备份] hysteria2 节点` | **87** 个 | `8.42%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **64** 个 | `6.20%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `4.16%` |
| 7 | `📱 Pawdroid 免费节点库` | **20** 个 | `1.94%` |
| 8 | `[长效备份] hy2 节点` | **17** 个 | `1.65%` |
| 9 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.36%` |
| **-** | **总计 (包含跨源重合)** | **1033** 个 | `100.00%` |
