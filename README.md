...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-25--07%3A24%3A40-green.svg?style=flat-square)
![Nodes](https://img.shields.io/badge/Valid_Nodes-871-orange.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-09-25 07:24:40`
> 运行分析：从 `9` 个活跃源中抓取 `1030` 个节点，耗时 `0.46s`。去重后保留 `871` 个有效节点。

<div style="overflow-x: auto;">

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇨🇭瑞士 | 🇮🇳印度 | 🇹🇷土耳其 | 🇦🇺澳大利亚 | 🇲🇾马来西亚 | 🇦🇷阿根廷 | 🇲🇽墨西哥 | 🇮🇹意大利 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇮🇪爱尔兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇨🇿捷克 | 🇦🇹奥地利 | 🇦🇪阿联酋 | 🇨🇾塞浦路斯 | 🇺🇦乌克兰 | 🇳🇴挪威 | 🇵🇹葡萄牙 | 🇭🇺匈牙利 | 🇿🇦南非 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 40 | 11 | 37 | 250 | 43 | 25 | 15 | 16 | 13 | 3 | 4 | 18 | 3 | 3 | 7 | 3 | 1 | 1 | 1 | 2 | 9 | 15 | 119 | 4 | 2 | 5 | 3 | 2 | 4 | 2 | 1 | 3 | 1 | 1 | 1 | 1 | 202 | **871** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `53.97%` |
| 2 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `14.13%` |
| 3 | `[长效备份] hysteria2 节点` | **113** 个 | `11.09%` |
| 4 | `📡 shaoyouvip 每日更新` | **75** 个 | `7.36%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **50** 个 | `4.91%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `4.22%` |
| 7 | `📱 Pawdroid 免费节点库` | **20** 个 | `1.96%` |
| 8 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.37%` |
| 9 | `[长效备份] hy2 节点` | **10** 个 | `0.98%` |
| **-** | **总计 (包含跨源重合)** | **1019** 个 | `100.00%` |
