...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-18--02%3A31%3A20-green.svg?style=flat-square)
![Nodes](https://img.shields.io/badge/Valid_Nodes-843-orange.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-09-18 02:31:20`
> 运行分析：从 `10` 个活跃源中抓取 `992` 个节点，耗时 `2.24s`。去重后保留 `843` 个有效节点。

<div style="overflow-x: auto;">

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇨🇭瑞士 | 🇮🇳印度 | 🇹🇷土耳其 | 🇦🇺澳大利亚 | 🇲🇾马来西亚 | 🇧🇷巴西 | 🇦🇷阿根廷 | 🇲🇽墨西哥 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇮🇪爱尔兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇦🇹奥地利 | 🇦🇪阿联酋 | 🇨🇾塞浦路斯 | 🇺🇦乌克兰 | 🇳🇴挪威 | 🇩🇰丹麦 | 🇧🇬保加利亚 | 🇿🇦南非 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 39 | 11 | 44 | 237 | 32 | 25 | 20 | 11 | 14 | 6 | 4 | 12 | 1 | 4 | 8 | 5 | 1 | 3 | 2 | 1 | 8 | 13 | 119 | 6 | 2 | 3 | 1 | 4 | 3 | 1 | 2 | 1 | 2 | 1 | 2 | 195 | **843** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `56.18%` |
| 2 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `14.71%` |
| 3 | `[长效备份] hysteria2 节点` | **121** 个 | `12.36%` |
| 4 | `⚡ Misaka Chromego 聚合池` | **52** 个 | `5.31%` |
| 5 | `📡 Huibq 聚合` | **43** 个 | `4.39%` |
| 6 | `[长效备份] hy2 节点` | **23** 个 | `2.35%` |
| 7 | `📱 Pawdroid 免费节点库` | **20** 个 | `2.04%` |
| 8 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.43%` |
| 9 | `我的私密机场 1` | **7** 个 | `0.72%` |
| 10 | `📡 shaoyouvip 每日更新` | **5** 个 | `0.51%` |
| **-** | **总计 (包含跨源重合)** | **979** 个 | `100.00%` |
