...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-22--13%3A20%3A09-green.svg?style=flat-square)
![Nodes](https://img.shields.io/badge/Valid_Nodes-907-orange.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-09-22 13:20:09`
> 运行分析：从 `9` 个活跃源中抓取 `1064` 个节点，耗时 `0.41s`。去重后保留 `907` 个有效节点。

<div style="overflow-x: auto;">

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇨🇭瑞士 | 🇮🇳印度 | 🇹🇷土耳其 | 🇦🇺澳大利亚 | 🇲🇾马来西亚 | 🇧🇷巴西 | 🇦🇷阿根廷 | 🇲🇽墨西哥 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇮🇪爱尔兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇨🇿捷克 | 🇦🇹奥地利 | 🇦🇪阿联酋 | 🇨🇾塞浦路斯 | 🇺🇦乌克兰 | 🇳🇴挪威 | 🇭🇺匈牙利 | 🇿🇦南非 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 41 | 13 | 36 | 241 | 35 | 25 | 28 | 20 | 23 | 4 | 4 | 19 | 3 | 3 | 9 | 4 | 1 | 2 | 1 | 1 | 10 | 14 | 122 | 5 | 3 | 9 | 6 | 2 | 7 | 3 | 1 | 2 | 1 | 1 | 1 | 207 | **907** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `52.33%` |
| 2 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `13.70%` |
| 3 | `📡 shaoyouvip 每日更新` | **100** 个 | `9.51%` |
| 4 | `[长效备份] hysteria2 节点` | **97** 个 | `9.23%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **66** 个 | `6.28%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `4.09%` |
| 7 | `📱 Pawdroid 免费节点库` | **20** 个 | `1.90%` |
| 8 | `[长效备份] hy2 节点` | **17** 个 | `1.62%` |
| 9 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.33%` |
| **-** | **总计 (包含跨源重合)** | **1051** 个 | `100.00%` |
