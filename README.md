...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-25--20%3A09%3A03-green.svg?style=flat-square)
![Nodes](https://img.shields.io/badge/Valid_Nodes-855-orange.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-09-25 20:09:03`
> 运行分析：从 `9` 个活跃源中抓取 `999` 个节点，耗时 `0.38s`。去重后保留 `855` 个有效节点。

<div style="overflow-x: auto;">

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇨🇭瑞士 | 🇮🇳印度 | 🇹🇷土耳其 | 🇦🇺澳大利亚 | 🇲🇾马来西亚 | 🇧🇷巴西 | 🇦🇷阿根廷 | 🇲🇽墨西哥 | 🇮🇹意大利 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇮🇪爱尔兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇨🇿捷克 | 🇦🇹奥地利 | 🇦🇪阿联酋 | 🇨🇾塞浦路斯 | 🇺🇦乌克兰 | 🇳🇴挪威 | 🇩🇰丹麦 | 🇵🇹葡萄牙 | 🇿🇦南非 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 43 | 12 | 33 | 240 | 29 | 25 | 16 | 20 | 11 | 3 | 3 | 17 | 4 | 3 | 7 | 3 | 1 | 2 | 1 | 1 | 2 | 9 | 6 | 119 | 3 | 2 | 6 | 4 | 2 | 4 | 2 | 1 | 3 | 1 | 1 | 2 | 1 | 213 | **855** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `55.67%` |
| 2 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `14.57%` |
| 3 | `[长效备份] hysteria2 节点` | **95** 个 | `9.62%` |
| 4 | `⚡ Misaka Chromego 聚合池` | **56** 个 | `5.67%` |
| 5 | `📡 shaoyouvip 每日更新` | **56** 个 | `5.67%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `4.35%` |
| 7 | `📱 Pawdroid 免费节点库` | **20** 个 | `2.02%` |
| 8 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.42%` |
| 9 | `[长效备份] hy2 节点` | **10** 个 | `1.01%` |
| **-** | **总计 (包含跨源重合)** | **988** 个 | `100.00%` |
