...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-23--05%3A38%3A23-green.svg?style=flat-square)
![Nodes](https://img.shields.io/badge/Valid_Nodes-878-orange.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-09-23 05:38:23`
> 运行分析：从 `9` 个活跃源中抓取 `1000` 个节点，耗时 `0.37s`。去重后保留 `878` 个有效节点。

<div style="overflow-x: auto;">

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇨🇭瑞士 | 🇮🇳印度 | 🇹🇷土耳其 | 🇦🇺澳大利亚 | 🇲🇾马来西亚 | 🇧🇷巴西 | 🇦🇷阿根廷 | 🇲🇽墨西哥 | 🇮🇹意大利 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇮🇪爱尔兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇨🇿捷克 | 🇦🇹奥地利 | 🇦🇪阿联酋 | 🇨🇾塞浦路斯 | 🇺🇦乌克兰 | 🇳🇴挪威 | 🇩🇰丹麦 | 🇭🇺匈牙利 | 🇿🇦南非 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 40 | 11 | 35 | 256 | 34 | 25 | 22 | 15 | 11 | 4 | 4 | 20 | 2 | 4 | 7 | 3 | 1 | 1 | 1 | 1 | 2 | 11 | 14 | 120 | 8 | 2 | 10 | 1 | 1 | 5 | 3 | 1 | 2 | 1 | 1 | 1 | 1 | 197 | **878** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `55.72%` |
| 2 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `14.59%` |
| 3 | `[长效备份] hysteria2 节点` | **94** 个 | `9.52%` |
| 4 | `📡 shaoyouvip 每日更新` | **81** 个 | `8.21%` |
| 5 | `📡 Huibq 聚合` | **43** 个 | `4.36%` |
| 6 | `⚡ Misaka Chromego 聚合池` | **25** 个 | `2.53%` |
| 7 | `📱 Pawdroid 免费节点库` | **20** 个 | `2.03%` |
| 8 | `[长效备份] hy2 节点` | **16** 个 | `1.62%` |
| 9 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.42%` |
| **-** | **总计 (包含跨源重合)** | **987** 个 | `100.00%` |
