...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-23--21%3A49%3A59-green.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-09-23 21:49:59`
> 运行分析：从 `9` 个活跃源中抓取 `995` 个节点，耗时 `0.38s`。去重后保留 `841` 个有效节点。

<div style="overflow-x: auto;">

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇨🇭瑞士 | 🇮🇳印度 | 🇹🇷土耳其 | 🇦🇺澳大利亚 | 🇲🇾马来西亚 | 🇦🇷阿根廷 | 🇲🇽墨西哥 | 🇮🇹意大利 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇮🇪爱尔兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇨🇿捷克 | 🇦🇹奥地利 | 🇦🇪阿联酋 | 🇨🇾塞浦路斯 | 🇺🇦乌克兰 | 🇳🇴挪威 | 🇩🇰丹麦 | 🇿🇦南非 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 40 | 11 | 36 | 240 | 32 | 25 | 19 | 16 | 12 | 5 | 3 | 17 | 1 | 3 | 7 | 2 | 1 | 1 | 1 | 2 | 7 | 13 | 119 | 3 | 2 | 8 | 3 | 2 | 3 | 2 | 1 | 2 | 1 | 1 | 1 | 199 | **841** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `56.01%` |
| 2 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `14.66%` |
| 3 | `[长效备份] hysteria2 节点` | **107** 个 | `10.90%` |
| 4 | `⚡ Misaka Chromego 聚合池` | **56** 个 | `5.70%` |
| 5 | `📡 Huibq 聚合` | **43** 个 | `4.38%` |
| 6 | `📡 shaoyouvip 每日更新` | **36** 个 | `3.67%` |
| 7 | `📱 Pawdroid 免费节点库` | **20** 个 | `2.04%` |
| 8 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.43%` |
| 9 | `[长效备份] hy2 节点` | **12** 个 | `1.22%` |
| **-** | **总计 (包含跨源重合)** | **982** 个 | `100.00%` |
