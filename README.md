...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-20--02%3A50%3A19-green.svg?style=flat-square)
![Nodes](https://img.shields.io/badge/Valid_Nodes-805-orange.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-09-20 02:50:19`
> 运行分析：从 `9` 个活跃源中抓取 `950` 个节点，耗时 `0.49s`。去重后保留 `805` 个有效节点。

<div style="overflow-x: auto;">

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇨🇭瑞士 | 🇮🇳印度 | 🇹🇷土耳其 | 🇦🇺澳大利亚 | 🇲🇾马来西亚 | 🇧🇷巴西 | 🇦🇷阿根廷 | 🇲🇽墨西哥 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇮🇪爱尔兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇦🇹奥地利 | 🇦🇪阿联酋 | 🇨🇾塞浦路斯 | 🇺🇦乌克兰 | 🇳🇴挪威 | 🇩🇰丹麦 | 🇿🇦南非 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 39 | 11 | 35 | 225 | 32 | 25 | 13 | 10 | 12 | 4 | 4 | 11 | 1 | 3 | 7 | 3 | 1 | 1 | 1 | 1 | 7 | 13 | 119 | 4 | 2 | 3 | 1 | 4 | 3 | 1 | 2 | 2 | 1 | 1 | 203 | **805** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `58.70%` |
| 2 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `15.37%` |
| 3 | `[长效备份] hysteria2 节点` | **98** 个 | `10.46%` |
| 4 | `⚡ Misaka Chromego 聚合池` | **54** 个 | `5.76%` |
| 5 | `📡 Huibq 聚合` | **43** 个 | `4.59%` |
| 6 | `[长效备份] hy2 节点` | **17** 个 | `1.81%` |
| 7 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.49%` |
| 8 | `📱 Pawdroid 免费节点库` | **11** 个 | `1.17%` |
| 9 | `📡 shaoyouvip 每日更新` | **6** 个 | `0.64%` |
| **-** | **总计 (包含跨源重合)** | **937** 个 | `100.00%` |
