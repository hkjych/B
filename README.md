...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-26--08%3A50%3A46-green.svg?style=flat-square)
![Nodes](https://img.shields.io/badge/Valid_Nodes-883-orange.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-09-26 08:50:46`
> 运行分析：从 `9` 个活跃源中抓取 `1004` 个节点，耗时 `0.26s`。去重后保留 `883` 个有效节点。
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 40 | 12 | 34 | 263 | 30 | 25 | 20 | 20 | 16 | 4 | 3 | 17 | 2 | 3 | 7 | 3 | 1 | 1 | 1 | 1 | 1 | 11 | 7 | 131 | 4 | 3 | 4 | 2 | 1 | 6 | 2 | 1 | 2 | 1 | 1 | 1 | 1 | 1 | 1 | 199 | **883** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `55.39%` |
| 2 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `14.50%` |
| 3 | `📡 shaoyouvip 每日更新` | **100** 个 | `10.07%` |
| 4 | `[长效备份] hysteria2 节点` | **90** 个 | `9.06%` |
| 5 | `📡 Huibq 聚合` | **43** 个 | `4.33%` |
| 6 | `⚡ Misaka Chromego 聚合池` | **22** 个 | `2.22%` |
| 7 | `📱 Pawdroid 免费节点库` | **20** 个 | `2.01%` |
| 8 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.41%` |
| 9 | `[长效备份] hy2 节点` | **10** 个 | `1.01%` |
| **-** | **总计 (包含跨源重合)** | **993** 个 | `100.00%` |
