...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-18--21%3A08%3A10-green.svg?style=flat-square)
![Nodes](https://img.shields.io/badge/Valid_Nodes-884-orange.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-09-18 21:08:10`
> 运行分析：从 `10` 个活跃源中抓取 `990` 个节点，耗时 `2.15s`。去重后保留 `884` 个有效节点。
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 40 | 13 | 44 | 265 | 30 | 26 | 26 | 17 | 15 | 4 | 3 | 16 | 2 | 4 | 8 | 3 | 1 | 1 | 1 | 1 | 1 | 10 | 6 | 119 | 5 | 2 | 7 | 2 | 1 | 6 | 3 | 1 | 3 | 1 | 1 | 1 | 1 | 194 | **884** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `56.29%` |
| 2 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `14.74%` |
| 3 | `[长效备份] hysteria2 节点` | **104** 个 | `10.64%` |
| 4 | `📡 shaoyouvip 每日更新` | **76** 个 | `7.78%` |
| 5 | `📡 Huibq 聚合` | **43** 个 | `4.40%` |
| 6 | `📱 Pawdroid 免费节点库` | **20** 个 | `2.05%` |
| 7 | `[长效备份] hy2 节点` | **19** 个 | `1.94%` |
| 8 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.43%` |
| 9 | `我的私密机场 1` | **7** 个 | `0.72%` |
| 10 | `⚡ Misaka Chromego 聚合池` | **0** 个 | `0.00%` |
| **-** | **总计 (包含跨源重合)** | **977** 个 | `100.00%` |
