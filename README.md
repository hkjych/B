...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-23--08%3A53%3A55-green.svg?style=flat-square)
![Nodes](https://img.shields.io/badge/Valid_Nodes-889-orange.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-09-23 08:53:55`
> 运行分析：从 `9` 个活跃源中抓取 `1018` 个节点，耗时 `0.59s`。去重后保留 `889` 个有效节点。

<div style="overflow-x: auto;">

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇨🇭瑞士 | 🇮🇳印度 | 🇹🇷土耳其 | 🇦🇺澳大利亚 | 🇲🇾马来西亚 | 🇧🇷巴西 | 🇦🇷阿根廷 | 🇲🇽墨西哥 | 🇮🇹意大利 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇮🇪爱尔兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇨🇿捷克 | 🇦🇹奥地利 | 🇦🇪阿联酋 | 🇨🇾塞浦路斯 | 🇺🇦乌克兰 | 🇳🇴挪威 | 🇩🇰丹麦 | 🇧🇬保加利亚 | 🇿🇦南非 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 40 | 12 | 35 | 255 | 33 | 25 | 19 | 16 | 14 | 4 | 3 | 21 | 1 | 4 | 7 | 4 | 1 | 2 | 1 | 1 | 1 | 10 | 15 | 134 | 6 | 2 | 6 | 3 | 1 | 4 | 3 | 1 | 2 | 1 | 1 | 1 | 1 | 199 | **889** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `54.73%` |
| 2 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `14.33%` |
| 3 | `📡 shaoyouvip 每日更新` | **100** 个 | `9.95%` |
| 4 | `[长效备份] hysteria2 节点` | **93** 个 | `9.25%` |
| 5 | `📡 Huibq 聚合` | **43** 个 | `4.28%` |
| 6 | `⚡ Misaka Chromego 聚合池` | **25** 个 | `2.49%` |
| 7 | `📱 Pawdroid 免费节点库` | **20** 个 | `1.99%` |
| 8 | `[长效备份] hy2 节点` | **16** 个 | `1.59%` |
| 9 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.39%` |
| **-** | **总计 (包含跨源重合)** | **1005** 个 | `100.00%` |
