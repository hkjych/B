...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-24--08%3A51%3A10-green.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-09-24 08:51:10`
> 运行分析：从 `9` 个活跃源中抓取 `1041` 个节点，耗时 `0.43s`。去重后保留 `886` 个有效节点。

<div style="overflow-x: auto;">

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇨🇭瑞士 | 🇮🇳印度 | 🇹🇷土耳其 | 🇦🇺澳大利亚 | 🇲🇾马来西亚 | 🇦🇷阿根廷 | 🇲🇽墨西哥 | 🇮🇹意大利 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇮🇪爱尔兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇨🇿捷克 | 🇦🇹奥地利 | 🇦🇪阿联酋 | 🇨🇾塞浦路斯 | 🇺🇦乌克兰 | 🇳🇴挪威 | 🇩🇰丹麦 | 🇵🇹葡萄牙 | 🇿🇦南非 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 39 | 12 | 37 | 260 | 33 | 25 | 21 | 15 | 15 | 5 | 3 | 16 | 3 | 3 | 7 | 2 | 1 | 1 | 1 | 1 | 8 | 15 | 132 | 5 | 2 | 6 | 3 | 1 | 4 | 2 | 1 | 3 | 1 | 1 | 2 | 1 | 199 | **886** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `53.45%` |
| 2 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `13.99%` |
| 3 | `📡 shaoyouvip 每日更新` | **100** 个 | `9.72%` |
| 4 | `[长效备份] hysteria2 节点` | **96** 个 | `9.33%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **50** 个 | `4.86%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `4.18%` |
| 7 | `📱 Pawdroid 免费节点库` | **20** 个 | `1.94%` |
| 8 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.36%` |
| 9 | `[长效备份] hy2 节点` | **12** 个 | `1.17%` |
| **-** | **总计 (包含跨源重合)** | **1029** 个 | `100.00%` |
