...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-26--21%3A21%3A51-green.svg?style=flat-square)
![Nodes](https://img.shields.io/badge/Valid_Nodes-807-orange.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-09-26 21:21:51`
> 运行分析：从 `9` 个活跃源中抓取 `938` 个节点，耗时 `0.26s`。去重后保留 `807` 个有效节点。

<div style="overflow-x: auto;">

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇨🇭瑞士 | 🇮🇳印度 | 🇹🇷土耳其 | 🇦🇺澳大利亚 | 🇲🇾马来西亚 | 🇦🇷阿根廷 | 🇲🇽墨西哥 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇮🇪爱尔兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇦🇹奥地利 | 🇦🇪阿联酋 | 🇨🇾塞浦路斯 | 🇺🇦乌克兰 | 🇳🇴挪威 | 🇩🇰丹麦 | 🇿🇦南非 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 40 | 12 | 33 | 236 | 29 | 25 | 18 | 12 | 14 | 4 | 3 | 11 | 3 | 3 | 7 | 2 | 1 | 1 | 1 | 8 | 6 | 119 | 3 | 3 | 5 | 1 | 3 | 2 | 1 | 2 | 1 | 1 | 1 | 196 | **807** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `59.33%` |
| 2 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `15.53%` |
| 3 | `[长效备份] hysteria2 节点` | **86** 个 | `9.28%` |
| 4 | `⚡ Misaka Chromego 聚合池` | **50** 个 | `5.39%` |
| 5 | `📡 Huibq 聚合` | **43** 个 | `4.64%` |
| 6 | `📱 Pawdroid 免费节点库` | **20** 个 | `2.16%` |
| 7 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.51%` |
| 8 | `[长效备份] hy2 节点` | **10** 个 | `1.08%` |
| 9 | `📡 shaoyouvip 每日更新` | **10** 个 | `1.08%` |
| **-** | **总计 (包含跨源重合)** | **927** 个 | `100.00%` |
