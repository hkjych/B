...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-22--20%3A01%3A11-green.svg?style=flat-square)
![Nodes](https://img.shields.io/badge/Valid_Nodes-912-orange.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-09-22 20:01:11`
> 运行分析：从 `9` 个活跃源中抓取 `1070` 个节点，耗时 `0.51s`。去重后保留 `912` 个有效节点。

<div style="overflow-x: auto;">

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇨🇭瑞士 | 🇮🇳印度 | 🇹🇷土耳其 | 🇦🇺澳大利亚 | 🇲🇾马来西亚 | 🇧🇷巴西 | 🇦🇷阿根廷 | 🇲🇽墨西哥 | 🇮🇹意大利 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇮🇪爱尔兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇨🇿捷克 | 🇦🇹奥地利 | 🇦🇪阿联酋 | 🇨🇾塞浦路斯 | 🇺🇦乌克兰 | 🇳🇴挪威 | 🇩🇰丹麦 | 🇿🇦南非 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 41 | 13 | 38 | 271 | 51 | 25 | 20 | 16 | 11 | 4 | 4 | 20 | 1 | 3 | 7 | 3 | 1 | 1 | 1 | 1 | 2 | 9 | 13 | 119 | 4 | 2 | 6 | 4 | 2 | 5 | 3 | 1 | 3 | 1 | 1 | 1 | 204 | **912** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `52.03%` |
| 2 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `13.62%` |
| 3 | `📡 shaoyouvip 每日更新` | **98** 个 | `9.27%` |
| 4 | `[长效备份] hysteria2 节点` | **94** 个 | `8.89%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **78** 个 | `7.38%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `4.07%` |
| 7 | `📱 Pawdroid 免费节点库` | **20** 个 | `1.89%` |
| 8 | `[长效备份] hy2 节点` | **16** 个 | `1.51%` |
| 9 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.32%` |
| **-** | **总计 (包含跨源重合)** | **1057** 个 | `100.00%` |
