...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-20--13%3A21%3A45-green.svg?style=flat-square)
![Nodes](https://img.shields.io/badge/Valid_Nodes-906-orange.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-09-20 13:21:45`
> 运行分析：从 `9` 个活跃源中抓取 `1057` 个节点，耗时 `1.47s`。去重后保留 `906` 个有效节点。

<div style="overflow-x: auto;">

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇨🇭瑞士 | 🇮🇳印度 | 🇹🇷土耳其 | 🇦🇺澳大利亚 | 🇲🇾马来西亚 | 🇧🇷巴西 | 🇦🇷阿根廷 | 🇲🇽墨西哥 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇮🇪爱尔兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇨🇿捷克 | 🇦🇹奥地利 | 🇦🇪阿联酋 | 🇨🇾塞浦路斯 | 🇺🇦乌克兰 | 🇳🇴挪威 | 🇩🇰丹麦 | 🇵🇹葡萄牙 | 🇿🇦南非 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 39 | 12 | 36 | 258 | 34 | 25 | 25 | 16 | 28 | 4 | 3 | 19 | 3 | 3 | 7 | 3 | 1 | 1 | 1 | 2 | 9 | 13 | 124 | 8 | 3 | 6 | 3 | 1 | 5 | 3 | 1 | 2 | 1 | 1 | 1 | 1 | 204 | **906** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `52.68%` |
| 2 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `13.79%` |
| 3 | `📡 shaoyouvip 每日更新` | **100** 个 | `9.58%` |
| 4 | `[长效备份] hysteria2 节点` | **94** 个 | `9.00%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **62** 个 | `5.94%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `4.12%` |
| 7 | `📱 Pawdroid 免费节点库` | **20** 个 | `1.92%` |
| 8 | `[长效备份] hy2 节点` | **17** 个 | `1.63%` |
| 9 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.34%` |
| **-** | **总计 (包含跨源重合)** | **1044** 个 | `100.00%` |
