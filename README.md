...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-26--15%3A58%3A59-green.svg?style=flat-square)
![Nodes](https://img.shields.io/badge/Valid_Nodes-810-orange.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-09-26 15:58:59`
> 运行分析：从 `9` 个活跃源中抓取 `949` 个节点，耗时 `0.33s`。去重后保留 `810` 个有效节点。

<div style="overflow-x: auto;">

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇨🇭瑞士 | 🇮🇳印度 | 🇹🇷土耳其 | 🇦🇺澳大利亚 | 🇲🇾马来西亚 | 🇧🇷巴西 | 🇦🇷阿根廷 | 🇲🇽墨西哥 | 🇮🇹意大利 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇮🇪爱尔兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇨🇿捷克 | 🇦🇹奥地利 | 🇦🇪阿联酋 | 🇨🇾塞浦路斯 | 🇺🇦乌克兰 | 🇳🇴挪威 | 🇿🇦南非 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 41 | 12 | 33 | 237 | 29 | 25 | 17 | 13 | 12 | 4 | 3 | 12 | 3 | 3 | 7 | 2 | 1 | 1 | 1 | 1 | 1 | 8 | 6 | 119 | 3 | 2 | 5 | 3 | 1 | 4 | 2 | 1 | 2 | 1 | 1 | 194 | **810** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `58.64%` |
| 2 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `15.35%` |
| 3 | `[长效备份] hysteria2 节点` | **90** 个 | `9.59%` |
| 4 | `⚡ Misaka Chromego 聚合池` | **48** 个 | `5.12%` |
| 5 | `📡 Huibq 聚合` | **43** 个 | `4.58%` |
| 6 | `📱 Pawdroid 免费节点库` | **20** 个 | `2.13%` |
| 7 | `📡 shaoyouvip 每日更新` | **19** 个 | `2.03%` |
| 8 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.49%` |
| 9 | `[长效备份] hy2 节点` | **10** 个 | `1.07%` |
| **-** | **总计 (包含跨源重合)** | **938** 个 | `100.00%` |
