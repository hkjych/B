...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-22--07%3A33%3A12-green.svg?style=flat-square)
![Nodes](https://img.shields.io/badge/Valid_Nodes-898-orange.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-09-22 07:33:12`
> 运行分析：从 `9` 个活跃源中抓取 `1048` 个节点，耗时 `0.36s`。去重后保留 `898` 个有效节点。

<div style="overflow-x: auto;">

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇨🇭瑞士 | 🇮🇳印度 | 🇹🇷土耳其 | 🇦🇺澳大利亚 | 🇲🇾马来西亚 | 🇮🇩印尼 | 🇧🇷巴西 | 🇦🇷阿根廷 | 🇲🇽墨西哥 | 🇮🇹意大利 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇮🇪爱尔兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇨🇿捷克 | 🇦🇹奥地利 | 🇦🇪阿联酋 | 🇨🇾塞浦路斯 | 🇺🇦乌克兰 | 🇳🇴挪威 | 🇩🇰丹麦 | 🇭🇺匈牙利 | 🇧🇬保加利亚 | 🇿🇦南非 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 40 | 13 | 36 | 248 | 34 | 25 | 25 | 17 | 15 | 4 | 3 | 19 | 3 | 3 | 8 | 4 | 1 | 1 | 1 | 1 | 1 | 2 | 15 | 13 | 124 | 7 | 2 | 7 | 4 | 2 | 5 | 3 | 1 | 2 | 1 | 1 | 1 | 1 | 1 | 204 | **898** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `53.14%` |
| 2 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `13.91%` |
| 3 | `📡 shaoyouvip 每日更新` | **100** 个 | `9.66%` |
| 4 | `[长效备份] hysteria2 节点` | **97** 个 | `9.37%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **50** 个 | `4.83%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `4.15%` |
| 7 | `📱 Pawdroid 免费节点库` | **20** 个 | `1.93%` |
| 8 | `[长效备份] hy2 节点` | **17** 个 | `1.64%` |
| 9 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.35%` |
| **-** | **总计 (包含跨源重合)** | **1035** 个 | `100.00%` |
