...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-21--13%3A24%3A21-green.svg?style=flat-square)
![Nodes](https://img.shields.io/badge/Valid_Nodes-902-orange.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-09-21 13:24:21`
> 运行分析：从 `9` 个活跃源中抓取 `1052` 个节点，耗时 `0.42s`。去重后保留 `902` 个有效节点。

<div style="overflow-x: auto;">

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇨🇭瑞士 | 🇮🇳印度 | 🇹🇷土耳其 | 🇦🇺澳大利亚 | 🇲🇾马来西亚 | 🇧🇷巴西 | 🇦🇷阿根廷 | 🇲🇽墨西哥 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇮🇪爱尔兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇦🇹奥地利 | 🇦🇪阿联酋 | 🇨🇾塞浦路斯 | 🇺🇦乌克兰 | 🇳🇴挪威 | 🇩🇰丹麦 | 🇭🇺匈牙利 | 🇧🇬保加利亚 | 🇿🇦南非 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 43 | 12 | 37 | 256 | 32 | 26 | 21 | 16 | 21 | 5 | 3 | 19 | 3 | 3 | 7 | 4 | 3 | 2 | 1 | 1 | 9 | 14 | 127 | 6 | 3 | 6 | 2 | 4 | 3 | 1 | 3 | 1 | 1 | 1 | 1 | 1 | 204 | **902** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `52.94%` |
| 2 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `13.86%` |
| 3 | `📡 shaoyouvip 每日更新` | **100** 个 | `9.62%` |
| 4 | `[长效备份] hysteria2 节点` | **87** 个 | `8.37%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **64** 个 | `6.16%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `4.14%` |
| 7 | `📱 Pawdroid 免费节点库` | **20** 个 | `1.92%` |
| 8 | `[长效备份] hy2 节点` | **17** 个 | `1.64%` |
| 9 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.35%` |
| **-** | **总计 (包含跨源重合)** | **1039** 个 | `100.00%` |
