...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-25--13%3A20%3A20-green.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-09-25 13:20:20`
> 运行分析：从 `9` 个活跃源中抓取 `1015` 个节点，耗时 `0.36s`。去重后保留 `876` 个有效节点。

<div style="overflow-x: auto;">

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇨🇭瑞士 | 🇮🇳印度 | 🇹🇷土耳其 | 🇦🇺澳大利亚 | 🇲🇾马来西亚 | 🇦🇷阿根廷 | 🇲🇽墨西哥 | 🇮🇹意大利 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇮🇪爱尔兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇨🇿捷克 | 🇦🇹奥地利 | 🇦🇪阿联酋 | 🇨🇾塞浦路斯 | 🇺🇦乌克兰 | 🇳🇴挪威 | 🇩🇰丹麦 | 🇵🇹葡萄牙 | 🇭🇺匈牙利 | 🇧🇬保加利亚 | 🇿🇦南非 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 39 | 12 | 36 | 248 | 33 | 25 | 18 | 14 | 19 | 4 | 3 | 20 | 3 | 3 | 7 | 2 | 1 | 1 | 1 | 2 | 8 | 13 | 121 | 5 | 2 | 6 | 2 | 2 | 4 | 2 | 1 | 2 | 1 | 1 | 1 | 1 | 2 | 1 | 210 | **876** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `54.78%` |
| 2 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `14.34%` |
| 3 | `[长效备份] hysteria2 节点` | **99** 个 | `9.86%` |
| 4 | `📡 shaoyouvip 每日更新` | **68** 个 | `6.77%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **56** 个 | `5.58%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `4.28%` |
| 7 | `📱 Pawdroid 免费节点库` | **20** 个 | `1.99%` |
| 8 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.39%` |
| 9 | `[长效备份] hy2 节点` | **10** 个 | `1.00%` |
| **-** | **总计 (包含跨源重合)** | **1004** 个 | `100.00%` |
